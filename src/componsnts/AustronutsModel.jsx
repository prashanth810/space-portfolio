...
const AustronutsModel = (props) => {
    const group = useRef()
    const { nodes, materials, animations } = useGLTF("/models/austonoid.glb")
    ...
    const YPotition = useMotionValue(5);
    const YSpring = useSpring(YPotition, { dumping: 30 });
...
export default AustronutsModel;